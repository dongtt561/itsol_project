<?php include ROOT_PATH.'/views/admin/admin_header.php';?>
        ...
        <div id="admin_content">   
            <div class="add_video">
                ...
                <?php  
                    $po=new adminController();
                    $post=$po->getPostbyID();
                ?>
                <div id="ckedit_main">
                    <form method="post" action="index.php?controller=admin&action=save_editPost" enctype="multipart/form-data">
                        <label id="space">Tiêu đề bài viết: </label>
                        <textarea id= "ip_video"  name="title" value="<?php echo $post['title']; ?>" minlength="1"  maxlength="200" required></textarea>
                        <div id="clear"></div>

                        <label id="space">Mô tả bài viết:</label>
                        <textarea id= "ip_video"  value="<?php echo $post['summary_post']; ?>" name="description" minlength="1" required></textarea>
                        <div id="clear"></div>

                        <label id="space">Tác giả:</label>
                        <input type="text" id= "ip_video" value="<?php echo $post['author']; ?>" name="author" minlength="1" required>
                        </input>
                        <div id="clear"></div>
                        ...
                        <div id="clear"></div>
                        <textarea id= "ip" value="<?php echo $post['content']; ?>"  name="content" required></textarea>
                        <div id="clear"></div>
