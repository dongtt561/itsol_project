    ...
    <body>
        ...
        ?>
            <form method="post" action="xuly.php" enctype="multipart/form-data">
                ...
                <input  disabled="true" class="input" type="file" id="images" name="fileupload" maxlength="200"/>
                <div class="clear"></div>
                <label class="space">Tóm tắt:</label>
                <textarea  disabled="true" class="input" id="summary_post" name="summary_post" maxlength="500"> <?php ?></textarea>
                <div class="clear"></div>
                ...
                <textarea disabled="true" id="tacgia" class="input" name="author" maxlength="50"> <?php ?></textarea>
                <div class="clear"></div>
                <label class="space">Danh mục:</label>
                <div class="input">
                    <select class="space" disabled="true">
